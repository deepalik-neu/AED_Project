...
private void populateHospitalTable(){
     ...
     public void populateReciverRequestTable(){
        ...
        for(WorkRequest wr : hospCoOrganization.getWorkQueue().getWorkRequestList()){
            Object[] row = new Object[6];
            row[0] = wr;
            row[1] = wr.getSummary();
            row[2] = wr.getPatient().getName();
           
            row[3] = wr.getStatus();
            row[4] = wr.getPatient().getStatus(); 
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (rcr < 0) {
            ...
            JOptionPane.showMessageDialog(null, new JLabel("<html><h3 color='red'>Please select a row from the reciever request table</h3></html>"), "Warning", JOptionPane.WARNING_MESSAGE);
            return;
        }
        if (hosp < 0) {
           
            JOptionPane.showMessageDialog(null, new JLabel("<html><h3 color='red'>Please select a row from the hospital table</h3></html>"), "Warning", JOptionPane.WARNING_MESSAGE);
            return;
        }
            ...
            if(request.getStatus().equals("PlasmaBank Approved. Passing to Hospital Coordinator")){
                    ...
                    request.setStatus("Assigned to a Hospital");
                    ...
                    if (org != null) {
                        ...
                        System.out.println("in org: "+org.getName());
                        userAccount.getWorkQueue().getWorkRequestList().add(request);
                        JOptionPane.showMessageDialog(null, new JLabel(  "<html><h2 color='green'>Patient assigned to the Hospital!</h2></html>"), "Information", JOptionPane.INFORMATION_MESSAGE);
                        populateReciverRequestTable();
                    }
                    else {
                    JOptionPane.showMessageDialog(null, new JLabel(  "<html><h2>Sorry, organization is not present</h2></html>"), "Error", JOptionPane.ERROR_MESSAGE);
                    }
                }   
            else{
                JOptionPane.showMessageDialog(null, new JLabel(  "<html><h2>Patient is already in progress!</h2></html>"), "Warning", JOptionPane.WARNING_MESSAGE);
                }
